...
/*   Updated: 2023/10/16 10:43:37 by jlarue           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _name("default"), _hp(100), _attck(20), _energy(50)
{
    std::cout << GREEN <<"A ClapTrap named " << this->_name << " has been created !" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hp(100), _attck(20), _energy(50)
{
