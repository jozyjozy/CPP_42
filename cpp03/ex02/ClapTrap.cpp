...
/*   Updated: 2023/10/16 11:11:40 by jlarue           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _name("default"), _hp(100), _attck(100), _energy(30)
{
    std::cout << GREEN <<"A ClapTrap named " << this->_name << " has been created !" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hp(100), _attck(100), _energy(30)
{
